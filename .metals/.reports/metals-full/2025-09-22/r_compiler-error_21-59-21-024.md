file://<WORKSPACE>/modules/admin-api/src/main/scala/adminapi/HttpServer.scala
...
action parameters:
uri: file://<WORKSPACE>/modules/admin-api/src/main/scala/adminapi/HttpServer.scala
text:
```scala
// Пакет для admin-api
